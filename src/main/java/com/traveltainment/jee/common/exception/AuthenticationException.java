 ...
 * @author bernat
 */
public final class AuthenticationException extends AbstractApplicationException
{
     ...
     * @param message
     */
    public AuthenticationException(final Message message)
    {
        super(message);
        setFault();
    }
    ...
    {
        getIntegraMessage().setFault(createErrorRS("6666", "Authetication failed"));
    }
