...
public class TransactionRollbackExceptionTest
{
    ...
    public TransactionRollbackExceptionTest()
    {
    ...
    public void setUp()
    {
        ...
        {
            Logger.getLogger(TransactionRollbackExceptionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    /**
     * Test of setFault method, of class TransactionRollbackException.
     */
    @Test
    public void testSetFault()
    {
        ...
        try
        {
            throw new TransactionRollbackException(m);
        }
        catch(AbstractException ex)
        {
            try
            {
                String result = $(m.getSOAPMessage().getSOAPBody().getOwnerDocument())
                        ...
                        .xpath("//ota:OTA_ErrorRS[@ErrorCode = '7777']")
                        .attr("ErrorMessage");
                assertEquals("Transaction is set to rollback only or roll backed", result);
            }
            catch (SOAPException ex1)
            {
                Logger.getLogger(TransactionRollbackExceptionTest.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
