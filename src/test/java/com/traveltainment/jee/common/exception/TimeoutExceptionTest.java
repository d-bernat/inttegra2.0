...
public class TimeoutExceptionTest
{
    ...
    public void setUp()
    {
        ...
        {
            Logger.getLogger(TimeoutExceptionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        catch(AbstractException ex)
        {
            try
            {
                String result = $(m.getSOAPMessage().getSOAPBody().getOwnerDocument())
                        ...
                        .xpath("//ota:OTA_ErrorRS[@ErrorCode = '9999']")
                        .attr("ErrorMessage");
                assertEquals("Time out", result);
            }
            catch (SOAPException ex1)
            {
                Logger.getLogger(TimeoutExceptionTest.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
